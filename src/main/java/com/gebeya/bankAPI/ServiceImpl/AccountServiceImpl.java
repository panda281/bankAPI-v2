...
//    TransactionService transactionService;
    ...
    public ResponseModel updateAccountCustomer(long accountId, Account account){
        ...
        if (!isTheAccountExists(accountId))
    ...
    {
        if(!(isTheAccountExists(transferDTO.getSenderAccountNo()) && isTheAccountExists(transferDTO.getReceiverAccountNo())))
...
//            otpHandler(generatedOtp,customerData.getMobileNo());
    ...
    //potential error on otpHandler .onErrorMap()
